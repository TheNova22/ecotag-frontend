...
class _ManufacturerHomeState extends State<ManufacturerHome>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Color(0xffeef3ed),
      body: SafeArea(
                      ...
                      children: [
                        ClipPath(
                          ...
                          child: Container(
                            ...
                            height:
                                MediaQuery.of(context).size.width * 0.4 * 1.3,
                        ...
                        Positioned(
                          top: MediaQuery.of(context).size.width *
                              ...
                              1.3 *
                              0.2,
                          left: MediaQuery.of(context).size.width * 0.4 * 0.1,
                          child: Image.asset(
                            "assets/cloud.png",
                            scale: 0.7,
                          ),
...
class BackgroundClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    var bottomRoundnessFactor = 20.0;
    var path = Path();

    path.moveTo(0, size.height * 0.5);
    path.lineTo(0, size.height - bottomRoundnessFactor);
    path.quadraticBezierTo(0, size.height, bottomRoundnessFactor, size.height);
    path.lineTo(size.width - bottomRoundnessFactor, size.height);
    path.quadraticBezierTo(size.width, size.height, size.width,
        size.height - bottomRoundnessFactor);

    path.lineTo(size.width, roundnessFactor * 2);
    path.quadraticBezierTo(size.width - 10, roundnessFactor,
        size.width - roundnessFactor * 1.5, roundnessFactor * 1.5);
    path.lineTo(
        roundnessFactor * 0.6, size.height * 0.5 - roundnessFactor * 0.3);
    path.quadraticBezierTo(
        0, size.height * 0.5, 0, size.height * 0.5 + roundnessFactor);
